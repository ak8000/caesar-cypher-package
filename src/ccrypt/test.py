...
def test_verify_crypt():
    ...
    assert verify_crypt("hello", decrypted_text) is True, "Test case failed: verify_crypt('hello', decrypted_text)"
    assert verify_crypt("hello", "world") is False, "Test case failed: verify_crypt('hello', 'world')"
