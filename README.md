...
`` pip install https://pypi.org/project/nyu_caesar_crypt_mar24/0.1.10/ ``



To import the code, here's the basic program we created with it: [main.py](https://github.com/software-students-spring2024/3-python-package-exercise-ja-ia/blob/main/src/nyuCaesarCryptMar24/__main__.py)
...
`` python -m nyuCaesarCryptMar24 `` or ``python 3 nyuCaesarCryptMar24 ``
...
# PyPI page
- [Caesar Crypt](https://pypi.org/project/nyu-caesar-crypt-mar24/0.1.10)
